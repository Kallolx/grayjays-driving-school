            ...
            {filteredVersions.map((version) => (
              ...
              >
                ...
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-[#2c3149] mb-3">{version.title}</h3>
                  <p className="text-gray-600 text-base mb-4">{version.description}</p>
                  <div className="flex items-end justify-center gap-1">
                    <span className="text-4xl font-bold text-[#2c3149]">${version.price}</span>
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center gap-3 text-[#2c3149] font-medium border-b border-gray-100 pb-3">
                    <FileSpreadsheet className="w-5 h-5 text-yellow-500" />
                    <span className="text-base">{version.type === "BOTH" ? "G2 & G Tests" : `${version.type} Test Only`}</span>
                  </div>
